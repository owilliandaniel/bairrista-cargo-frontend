// AIFileUpload.tsx - AI-powered document upload with TypeScript
    ...
    try {
      ...
      if (setError) {
        const errorMessage = err instanceof AxiosError 
          ? err.response?.data?.detail || 'Erro ao processar arquivo'
          : 'Não foi possível extrair os dados do arquivo. Por favor, preencha manualmente.';
