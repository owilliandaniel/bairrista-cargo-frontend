// Pagamentos.tsx - Customer payment management with TypeScript
...
const AnimatedCreditCard = ({ cardData, isFlipped }: AnimatedCreditCardProps) => {
  ...
  const renderCardLogo = (brandName: string) => {
    switch(brandName) {
      case 'NUBANK':
        return (
    ...
    <div style={{ 
      ...
      <div style={{
        ...
        <div style={{
          ...
          background: getCardGradient(brand),
          borderRadius: '16px',
          padding: '24px',
          color: 'white',
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
            ...
            {renderCardLogo(brand.toUpperCase())}
          </div>
          <div style={{ 
            fontSize: '1.5rem',
            letterSpacing: '4px',
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between' }}>
            ...
            <div style={{ textAlign: 'right' }}>
              ...
              <div style={{ fontSize: '0.95rem', fontWeight: 600 }}>{cardData.expiry || 'MM/AA'}</div>
            </div>
          </div>
        </div>
        <div style={{
...
function Pagamentos({ cards, setCards }: PagamentosProps) {
  const [newCard, setNewCard] = useState<CardData>({ number: '', holder: '', expiry: '', cvv: '' });
