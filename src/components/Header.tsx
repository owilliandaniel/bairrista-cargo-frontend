  ...
  return (
    ...
    >
      ...
      >
        ...
        <nav className="nav" style={{ display: 'flex', alignItems: 'center', gap: '30px' }}>
            ...
            {!user ? (
                  ...
                  >
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                      ...
                      >
                        ...
                        <span>
                          <span style={{ fontWeight: 'bold', fontSize: '1.1rem', color: '#222' }}>Usuário</span>
                          <br />
              ...
              <>
                <Link to="/area-empresa" style={{ textDecoration: 'none' }}>
                  <button className="btn-primary" style={{ borderRadius: '0.5rem' }}>
                    Área do Cliente
                  </button>
                </Link>
