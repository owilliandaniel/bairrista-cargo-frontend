...
import { Icons } from './EmpresaIcons';
import '../../components/AreaCliente.css'; 

function CadastrarMotorista({ onSuccess }) {
  ...
  const [formData, setFormData] = useState({
    ...
    categoria_cnh: 'C',
    validade_cnh: '',
    // Dados do Veículo (Texto plano conforme seu models.py)
    placa_veiculo: '',
    modelo_veiculo: '',
    capacidade_carga_kg: ''
  });
    ...
    if (id) {
        ...
        if (veiculoEncontrado) {
            setFormData(prev => ({
                ...
                capacidade_carga_kg: veiculoEncontrado.capacidade || 0
            }));
        }
    } else {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Envia exatamente o que o seu models.py espera (Strings)
      ...
      // Limpa formulário
      setFormData({
        nome: '', email: '', senha: '', cnh: '', categoria_cnh: 'C', validade_cnh: '',
        placa_veiculo: '', modelo_veiculo: '', capacidade_carga_kg: ''
      });
      ...
      <form onSubmit={handleSubmit} style={{ display: 'grid', gap: '1.5rem' }}>
        ...
        <div className="detail-section">
           ...
           <div className="detail-grid">
              ...
              <div className="form-group">
                <label>Senha</label>
                <input type="password" name="senha" value={formData.senha} onChange={handleChange} required className="modal-input" />
              </div>
           </div>
        </div>
        ...
        {/* DADOS DO MOTORISTA */}
        <div className="detail-section">
           <h3 style={{ fontSize: '1rem', marginBottom: '1rem' }}><Icons.Truck /> Motorista e Veículo</h3>
           <div className="detail-grid">
              <div className="form-group">
                <label>CNH</label>
