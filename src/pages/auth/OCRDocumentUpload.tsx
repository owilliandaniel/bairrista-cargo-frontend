// OCRDocumentUpload.tsx - OCR/AI document upload with TypeScript
  ...
  const handleFileChange = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      const errorMessage = err instanceof AxiosError
        ? err.response?.data?.erro || 'Erro ao processar documento. Tente novamente.'
