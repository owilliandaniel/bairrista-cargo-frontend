...
interface ResultadoAnalise {
  itens_detectados?: ItemDetectado[]
}

interface InventarioIAProps {
  onItensDetectados?: (itens: ItemDetectado[]) => void
  disabled?: boolean
}
 ...
 * />
 */
function InventarioIA({ onItensDetectados, disabled = false }: InventarioIAProps) {
        ...
        <div className="ia-result-area">
          ...
          {resultado && (
            <div className="ia-items-detected">
              ...
              {resultado.itens_detectados && resultado.itens_detectados.length > 0 ? (
                      ...
                      <div className="ia-item-confidence">
                        <span
                          className={`confidence-badge ${
                            item.confianca > 0.8 ? 'high' : item.confianca > 0.5 ? 'medium' : 'low'
                          }`}
                        >
