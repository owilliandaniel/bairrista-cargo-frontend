...
interface EmpresaOperacionalProps {
  setSection: (section: SectionKey) => void;
}

function EmpresaOperacional({ setSection }: EmpresaOperacionalProps) {
  return (
    <div className="overview-container fade-in">
      <div style={{ marginBottom: '2rem' }}>
        <h2 style={{ fontSize: '1.5rem', fontWeight: 'bold', color: '#ffffffff' }}>Gestão Operacional</h2>
        <p style={{ color: '#a9acb3ff' }}>Gerencie suas operações de transporte.</p>
      </div>
...
export default EmpresaOperacional;